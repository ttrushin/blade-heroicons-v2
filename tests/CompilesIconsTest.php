...
use BladeUI\HeroiconsV2\BladeHeroiconsV2ServiceProvider;
...
class CompilesIconsTest extends TestCase
{
    ...
    {
        $result = svg('heroicon-v2-o-bell')->toHtml();
    ...
    {
        $result = svg('heroicon-v2-o-bell', 'w-6 h-6 text-gray-500')->toHtml();
    ...
    {
        $result = svg('heroicon-v2-o-bell', ['style' => 'color: #555'])->toHtml();
    ...
    protected function getPackageProviders($app)
    {
        return [
            ...
            BladeHeroiconsV2ServiceProvider::class,
        ];
    }
}
